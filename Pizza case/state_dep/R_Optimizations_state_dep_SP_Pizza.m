...
%% observing the state of the bottleneck(BN) in the pizza line
...
%     filename = ['OPT_PizzaL2000_anyDist_', num2str(i), '.mat'];
...
%% the machine being observed: Bottleneck - 1st machine
OM=1;
for x2=1:size(OM,2)
    ...
    for x1=1:size(C_H,2)
        ...
        writematrix(min_Cost,".\dep_results_Pizza_SP\"+str+".xls",'Sheet',1,'Range','A2');
        writematrix(AVG_No_Syn,".\dep_results_Pizza_SP\"+str+".xls",'Sheet',2,'Range','A2');
        writematrix(Syn_Policy,".\dep_results_Pizza_SP\"+str+".xls",'Sheet',2,'Range','C2');
        writematrix(elapsed_time,".\dep_results_Pizza_SP\"+str+".xls",'Sheet',3,'Range','A2');
    end
end
