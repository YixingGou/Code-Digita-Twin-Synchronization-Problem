...
% E is a vector of the machine efficiency
% BN is the number of the location of bottleneck machinem in the production line
...
% T=400001;%simulation duration:replace T with N*Delta in the following
%% Input Parameters
