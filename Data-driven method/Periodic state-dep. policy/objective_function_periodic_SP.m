...
function [AVG_cost,AVG_SynNUM]=objective_function_periodic_SP(quadruple)
...
%The periodic state-dependent synchronization policy with the parameters (w1,m1,w0,m0) sets the synchronization decision H 
%depending on the observation of the machine state Yn being either one or zero according to the following equation:
