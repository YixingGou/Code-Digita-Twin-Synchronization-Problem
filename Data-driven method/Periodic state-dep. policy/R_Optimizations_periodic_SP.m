...
%             options = optimoptions('surrogateopt', 'PlotFcn', []);
        ...
        writematrix(quadruple,".\per_results_REAL_SP\"+str+".xls",'Sheet',1,'Range','C2');
        writematrix(AVG_No_Syn,".\per_results_REAL_SP\"+str+".xls",'Sheet',2,'Range','A2');
        writematrix(Syn_Policy,".\per_results_REAL_SP\"+str+".xls",'Sheet',2,'Range','C2');
        writematrix(elapsed_time,".\per_results_REAL_SP\"+str+".xls",'Sheet',3,'Range','A2');
    end
end
